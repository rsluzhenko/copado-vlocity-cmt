import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfDemo_account_asset_detail_statements_current extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              connectedCallback() {
                ...
                this.setAttribute(
                  "class",
                  "card-a5L8Y00001QKqEsEAO"
                );
                this.getCommunityPrefix().then((result) => {
                  loadStyle(this, result +"/servlet/servlet.FileDownload?file=00P8Y00001gaZ8h").then(() =>{
                    //Loading Custom CSS.
                  })
                });
