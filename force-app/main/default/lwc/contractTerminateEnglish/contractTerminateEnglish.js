...
import { OMNIDEF } from './contractTerminateEnglish_def.js';
import tmpl from './contractTerminateEnglish.html';
import tmpl_nds from './contractTerminateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class contractTerminateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
