...
import { OMNIDEF } from './july24MEnglish_def.js';
import tmpl from './july24MEnglish.html';
import tmpl_nds from './july24MEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class july24MEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
